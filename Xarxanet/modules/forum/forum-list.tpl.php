...
<table id="forum-<?php print $forum_id; ?>">
  ...
  <?php foreach ($forums as $child_id => $forum): ?>
    <tr id="forum-list-<?php print $child_id; ?>"
			class="<?php print $forum->zebra; ?>">
			<td
				<?php print $forum->is_container ? 'colspan="4" class="container"' : 'class="forum"'; ?>>
        <?php 
/*
			       * Enclose the contents of this cell with X divs, where X is the depth this forum resides at. This will allow us to use CSS left-margin for indenting.
			       */
			?>
        <?php print str_repeat('<div class="indent">', $forum->depth); ?>
          <div
					class="icon forum-status-<?php print $forum->icon_class; ?>"
      ...
      <?php if (!$forum->is_container): ?>
        <td class="topics">
          ...
          <?php if ($forum->new_topics): ?>
            <br /> <a href="<?php print $forum->new_url; ?>"><?php print $forum->new_text; ?></a>
          <?php endif; ?>
        </td>
