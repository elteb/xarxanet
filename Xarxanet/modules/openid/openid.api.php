 ...
 * @param $request An
 *        	associative array of parameter defaults to which to modify or append.
 * @return An associative array of parameters to be merged with the default list.
 *        
 */
 ...
 * @param $account The
 *        	Drupal user account that logged in
 *        	
 */
 ...
 *
 * @return An associative array which keys are the name of the discovery methods and
 ...
 *
 * @return An array with a set of function callbacks, that will be called in turn
