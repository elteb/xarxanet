 ...
 *        	The instance definition. The hook might be called without an
 ...
 *        	entity type the field is attached to.
 * @param $entity The
 *        	entity object the field is attached to, or NULL if no entity
 *        	exists (e.g. in field settings page).
 *        	
 * @return The array of options for the field. Array keys are the values to be
