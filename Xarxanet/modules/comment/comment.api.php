 ...
 *
 * @param $comments An
 *        	array of comment objects indexed by cid.
 */
...
/**
 * The comment is being viewed.
 * This hook can be used to add additional data to the comment before theming.
 *
 * @param $comment Passes
 *        	in the comment the action is being performed on.
 ...
 *
 * @param $build A
 *        	renderable array representing the comment.
 *        	
 * @see comment_view()
