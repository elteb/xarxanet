 ...
 *      
 * @param $field The
 *        	field structure being configured.
 * @param $instance The
 *        	instance structure being configured.
 * @param $has_data TRUE
 *        	if the field already has data, FALSE if not.
 *        	
 * @return The form definition for the field settings.
 */
 ...
 *        	instance structure being configured.
 *        	
 * @return The form definition for the field instance settings.
 */
 ...
 *        	instance structure being configured.
 *        	
 * @return The form definition for the widget settings.
 */
 ...
 *        	instance structure being configured.
 * @param $view_mode The
 *        	view mode being configured.
 * @param $form The
 *        	(entire) configuration form array, which will usually have no use here.
 * @param $form_state The
 *        	form state of the (entire) configuration form.
 *        	
 * @return The form elements for the formatter settings.
 */
 ...
 *        	instance structure.
 * @param $view_mode The
 *        	view mode for which a settings summary is requested.
 *        	
 * @return A string containing a short summary of the formatter settings.
 */
