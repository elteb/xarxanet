 ...
 * @param $entity The
 *        	$entity to which $file is referenced.
 *        	
 * @return TRUE is access should be allowed by this entity or FALSE if denied. Note
 ...
 *
 * @param $grants An
 *        	array of grants gathered by hook_file_download_access(). The array is
