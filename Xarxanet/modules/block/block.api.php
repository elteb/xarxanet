 ...
 *
 * @return An associative array whose keys define the delta for each block and whose
 ...
 *
 * @param $blocks A
 *        	multidimensional array of blocks keyed by the defining module and delta;
 ...
 * @param $theme The
 *        	theme these blocks belong to.
 * @param $code_blocks The
 *        	blocks as defined in hook_block_info() before being overwritten by the
 *        	database data.
 *        	
 * @see hook_block_info()
 */
 ...
 *
 * @param $delta Which
 *        	block is being configured. This is a unique identifier for the block
 *        	within the module, defined in hook_block_info().
 *        	
 * @return A configuration form, if one is needed for your block beyond the standard
 ...
 *        	within the module, defined in hook_block_info().
 * @param $edit The
 *        	submitted form data from the configuration form.
 *        	
 *        	For a detailed usage example, see block_example.module.
 *        	
 * @see hook_block_configure()
 ...
 *
 * @param $delta Which
 *        	block to render. This is a unique identifier for the block
 *        	within the module, defined in hook_block_info().
 *        	
 * @return Either an empty array so the block will not be shown or an array containing
 ...
 *
 * @param $data The
 *        	data as returned from the hook_block_view() implementation of the
 ...
 * @param $block The
 *        	block object, as loaded from the database, having the main properties:
 ...
 *
 * @param $blocks An
 *        	array of $blocks, keyed by the block ID.
 */
