 ...
 *
 * @return A list of mapping structures, where each mapping is an associative array:
 ...
 * namespace prefix.
 *
 * @return An associative array of namespaces where the key is the namespace prefix
