 ...
 *
 * @param $links Nested
 *        	array of links keyed by language code.
 * @param $type The
 *        	language type the links will switch.
 * @param $path The
 *        	current path.
 */
 ...
 *
 * @return An associative array of language type definitions. The keys are the
 ...
 *        
 * @see hook_language_types_info_alter() @ingroup language_negotiation
 */
 ...
 *
 * @param $language_types Array
 *        	of language type definitions.
 *        	
 * @see hook_language_types_info() @ingroup language_negotiation
 */
 ...
 *
 * @return An associative array of language negotiation provider definitions. The keys
 ...
 *        
 * @see hook_language_negotiation_info_alter() @ingroup language_negotiation
 */
 ...
 *
 * @param $language_providers Array
 *        	of language negotiation provider definitions.
 *        	
 * @see hook_language_negotiation_info() @ingroup language_negotiation
 */
 ...
 *
 * @param $fallback_candidates An
 *        	array of language codes whose order will determine the language fallback
 *        	order.
 */
