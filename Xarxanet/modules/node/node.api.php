 ...
 *
 * @param $account The
 *        	user object whose grants are requested.
 * @param $op The
 *        	node operation to be performed, such as 'view', 'update', or 'delete'.
 *        	
 * @return An array whose keys are "realms" of grants, and whose values are arrays of
 ...
 *
 * @param $node The
 *        	node that has just been saved.
 *        	
 * @return An array of grants as defined above.
 *        
 * @see hook_node_access_records_alter() @ingroup node_access
 */
 ...
 *
 * @see hook_node_access_records() Upon viewing, editing or deleting a node, hook_node_grants() builds a
 ...
 *
 * @param $grants The
 *        	$grants array returned by hook_node_access_records().
 * @param $node The
 *        	node for which the grants were acquired.
 *        	
 ...
 *
 * @see hook_node_grants() The resulting grants are then checked against the records stored in the
 ...
 *
 * @param $grants The
 *        	$grants array returned by hook_node_grants().
 * @param $account The
 *        	user account requesting access to content.
 * @param $op The
 *        	operation being performed, 'view', 'update' or 'delete'.
 *        	
 ...
 * checked nodes.
 *
 * @return An array of operations. Each operation is an associative array that may
 ...
 *
 * @param $node The
 *        	node revision (node object) that is being deleted.
 *        	
 *        	@ingroup node_api_hooks
 */
function hook_node_revision_delete($node) {
	db_delete ( 'mytable' )->condition ( 'vid', $node->vid )->execute ();
}
 ...
 *
 * @param $nodes An
 *        	array of the nodes being loaded, keyed by nid.
 * @param $types An
 *        	array containing the node types present in $nodes. Allows for an early
 ...
 *      
 * @param $node Either
 *        	a node object or the machine name of the content type on which to
 ...
 *        	- "view"
 * @param $account The
 *        	user object to perform the access check operation on.
 *        	
 * @return - NODE_ACCESS_ALLOW: if the operation is to be allowed.
 ...
 *
 * @param $node The
 *        	node that is about to be shown on the add/edit form.
 *        	
 *        	@ingroup node_api_hooks
 */
 ...
 *
 * @param $node The
 *        	node being displayed in a search result.
 *        	
 * @return array Extra information to be displayed with search result. This information
 ...
 * @see search-result.tpl.php @ingroup node_api_hooks
 */
 ...
 *
 * @param $node The
 *        	node that is being inserted or updated.
 *        	
 *        	@ingroup node_api_hooks
 */
 ...
 *        	node being indexed.
 *        	
 * @return string Additional node information to be indexed.
 *        
 *         @ingroup node_api_hooks
 */
 ...
 * @param $form The
 *        	form being used to edit the node.
 ...
 *
 * @param $node The
 *        	node object being updated in response to a form submission.
 * @param $form The
 *        	form being used to edit the node.
 * @param $form_state The
 *        	form state array.
 ...
 *
 * @param $node The
 *        	node that is being assembled for rendering.
 * @param $view_mode The
 *        	$view_mode parameter from node_view().
 * @param $langcode The
 *        	language code used for rendering.
 *        	
 * @see hook_entity_view() @ingroup node_api_hooks
 */
 ...
 *
 * @param $build A
 *        	renderable array representing the node content.
 *        	
 * @see node_view()
 * @see hook_entity_view_alter() @ingroup node_api_hooks
 */
 ...
 *
 * @return An array of information defining the module's node types. The array
 ...
 *
 * @return An associative array of ranking data. The keys should be strings,
 ...
 *
 * @param $info The
 *        	node type object that is being created.
 */
 ...
 *
 * @param $info The
 *        	node type object that is being updated.
 */
 ...
 *
 * @param $info The
 *        	node type object that is being deleted.
 */
 ...
 *
 * @param $node The
 *        	node being added or edited.
 * @param $form_state The
 *        	form state array.
 *        	
 * @return An array containing the title and any custom form elements to be displayed
 ...
 *
 * @param $node The
 *        	node to be displayed, as returned by node_load().
 * @param $view_mode View
 *        	mode, e.g. 'full', 'teaser', ...
 * @return The passed $node parameter should be modified as necessary and returned so
