 ...
 *
 * @param $projects Reference
 *        	to an array of the projects installed on the system. This
 ...
 *
 * @param $projects Reference
 *        	to an array of information about available updates to each
 ...
 *        	
 * @return If there are any problems, return an array of error messages. If there are
 *         no problems, return an empty array.
 *        
 * @see update_manager_archive_verify() @ingroup update_manager_file
 */
