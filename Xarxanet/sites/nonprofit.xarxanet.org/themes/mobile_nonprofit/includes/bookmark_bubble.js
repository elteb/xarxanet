...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (isAndroid) { bubbleInner.innerHTML = '<b>Install this website in your device:</b> ' +
        'Bookmark it and add it to Homepage'; }
  else {
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'Install this website in your device: ' +
        'click the arrow and <b>\'Add to homepage\'</b>';
  } else {
    bubbleInner.innerHTML = 'Install this website in your device: ' +
        'click <b style="font-size:15px">+</b> and ' +
        '<b>\'Add to homepage\'</b>';
  }
  }
