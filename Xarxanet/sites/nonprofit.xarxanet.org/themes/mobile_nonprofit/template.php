 ...
 */
function mobile_nonprofit_preprocess_page(&$vars) {	 
 ...
 */
function mobile_nonprofit_preprocess_html(&$vars) {
 ...
 */
function mobile_nonprofit_preprocess_comment_wrapper(&$vars) {
 ...
 * Preprocess node
 */
function mobile_nonprofit_preprocess_node(&$variables) {
	$node = $variables['node'];
 ...
 */
function mobile_nonprofit_get_label($tipus) {
	$text = $tipus;
	...
	$news_type_icon_filename = str_replace(array('_',' '),'-',mobile_nonprofit_drop_accents(strtolower($tipus)));
...
*/
function mobile_nonprofit_drop_accents($incoming_string){
