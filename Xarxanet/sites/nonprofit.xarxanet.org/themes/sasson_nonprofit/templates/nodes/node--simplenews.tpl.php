			...
			<table width="100%" class="contents">
				<tr>
					<td align="center" class="inner">
						<table width="272">
							<tr>
								<td class="inner h1 titol-seccio">
									News &amp; Interviews
								</td>
							</tr>
						</table>
							    ...
							    <tr>
							        <td>
							            <a href="<?php echo $noticia_prin_esq['link']?>">
											<img class="img-article" src="<?php echo $noticia_prin_esq['imatge']?>" alt="<?php echo $noticia_prin_esq['alt']?>"/>
										</a>
							        </td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							        <td>
							            <a href="<?php echo $noticia_prin_dreta['link']?>">
											<img class="img-article" src="<?php echo $noticia_prin_dreta['imatge']?>" alt="<?php echo $noticia_prin_dreta['alt']?>"/>
										</a>
							        </td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							        <td>
							            <a href="<?php echo $noticia_secundaria_esq['link']?>" style="text-decoration:none">
											<img class="img-article" src="<?php echo $noticia_secundaria_esq['imatge']?>" alt="<?php echo $noticia_secundaria_esq['alt']?>"/>
										</a>
							        </td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							        <td>
							            <a href="<?php echo $noticia_secundaria_dreta['link']?>" style="text-decoration:none">
											<img class="img-article" src="<?php echo $noticia_secundaria_dreta['imatge']?>" alt="<?php echo $noticia_secundaria_dreta['alt']?>"/>
										</a>
							        </td>
							    </tr>
							    <tr>
			...
			<table width="100%" class="contents">
				<tr>
					<td align="center" class="inner">
						<table width="185">
							<tr>
								<td align="center" class="inner h1 titol-seccio">
									Opinion
								</td>
							</tr>
						</table>
		                ...
		                <tr>
		                    <td>
		                        <a href="<?php echo $opinion_primera['link']?>" style="text-decoration:none">
									<img class="img-article" src="<?php echo $opinion_primera['imatge']?>" alt="<?php echo $opinion_primera['alt']?>"/>
								</a>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    <td>
		                        <a href="<?php echo $opinion_segona['link']?>" style="text-decoration:none">
									<img class="img-article" src="<?php echo $opinion_segona['imatge']?>" alt="<?php echo $opinion_segona['alt']?>"/>
								</a>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    <td>
		                        <a href="<?php echo $opinion_tercera['link']?>" style="text-decoration:none">
									<img class="img-article" src="<?php echo $opinion_tercera['imatge']?>" alt="<?php echo $opinion_tercera['alt']?>"/>
								</a>
		                    </td>
		                </tr>
		                <tr>
