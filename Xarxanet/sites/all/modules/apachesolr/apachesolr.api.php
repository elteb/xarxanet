...
/**
 * Add index mappings for Field API types.
 * The default mappings array
 ...
 *        	An object implementing DrupalSolrQueryInterface. No need for &.
 *        	
 * @see /admin/reports/apachesolr - This report displays the active solr index fields and can help you
 ...
 * index.
 * if any module returns TRUE, the entity is skipped for indexing.
 *
 ...
 * inspected to be added to the index.
 * if any module returns TRUE, 
 ...
 * search.
 * This has been introduced in 6.x-beta7 as a replacement for the call
 * to HOOK_nodeapi().
 *
...
/**
 * Modify the returned spellings suggestions.
