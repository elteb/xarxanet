...
class SolrBaseQuery extends SolrFilterSubQuery implements DrupalSolrQueryInterface {
	...
	/**
	 * The query name is used to construct a searcher string.
	 * Mostly the
	 * environment id
	 */
	protected $name;
	 ...
	 *
	 * @param $name The
	 *        	search name, used for finding the correct blocks and other config.
	 *        	Typically "apachesolr".
	 *        	
	 * @param $solr An
	 *        	instantiated DrupalApacheSolrService Object.
	 *        	Can be instantiated from apachesolr_get_solr().
	 *        	
	 * @param $params Array
	 *        	of params to initialize the object (typically 'q' and 'fq').
	 *        	
	 * @param $sortstring Visible
	 *        	string telling solr how to sort - added to GET query params.
	 *        	
	 * @param $base_path The
	 *        	search base path (without the keywords) for this query, without trailing slash.
	 */
	 ...
	 *
	 * @param $field_map An
	 *        	array keyed with real Solr index field names with the alias as value.
	 *        	
	 * @return DrupalSolrQueryInterface The called object.
	 */
