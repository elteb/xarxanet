...
class WURFL_Handlers_FennecOnAndroidHandler extends WURFL_Handlers_Handler {
	...
	public function canHandle($userAgent) {
		if (WURFL_Handlers_Utils::isDesktopBrowser ( $userAgent ))
			return false;
		return (WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'Android' ) && WURFL_Handlers_Utils::checkIfContainsAnyOf ( $userAgent, array (
				'Fennec',
				'Firefox' 
		) ));
	}
	...
	public function applyRecoveryMatch($userAgent) {
		...
		if ($is_fennec || $is_firefox) {
			if ($is_fennec || WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'Mobile' ))
			...
			if ($is_firefox) {
				...
				if (WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'Desktop' ))
