...
class WURFL_DeviceRepositoryBuilder {
	 ...
	 *        	Filename of wurfl.xml or other complete WURFL file
	 * @param array $wurflPatches
	 *        	Array of WURFL patch files
	 * @param array $capabilityFilter
	 *        	Array of capabilities to be included in the DeviceRepository
	 ...
	 *        	arrray of WURFL_Xml_DeviceIterator objects for patch files
	 * @throws Exception
	 */
	 ...
	 * @param array $capabilityFilter
	 *        	Array of (string) WURFL capabilities
	 ...
	 * This is called when loading the WURFL XML
	...
	/**
	 *
	 * @param array $patchingDeviceIterators
	 *        	Array of WURFL_Xml_DeviceIterators
	 ...
	 * 
	 * @param array $currentPatchingDevices
	 *        	REFERENCE to array of current devices to be patches
	 * @param array $newPatchingDevices
	 *        	Array of new devices to be patched in
	 */
