...
class WURFL_Handlers_SmartTVHandler extends WURFL_Handlers_Handler {
	...
	public function applyRecoveryMatch($userAgent) {
		...
		if (WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'GoogleTV' ))
			return 'generic_smarttv_googletv_browser';
		if (WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'AppleTV' ))
			return 'generic_smarttv_appletv_browser';
		if (WURFL_Handlers_Utils::checkIfContains ( $userAgent, 'Boxee' ))
