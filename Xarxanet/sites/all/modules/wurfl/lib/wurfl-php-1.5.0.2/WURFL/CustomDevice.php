...
class WURFL_CustomDevice {
	 ...
	 *        	Array of WURFL_Xml_ModelDevice objects
	 ...
	 *        	must be a valid capability name
	...
	/**
	 * Returns the nearest actual device root in the fall back tree.
	 * If this device is a device root itself,
	...
	/**
	 * Returns the top-most device.
	 * This is the "generic" device.
	 * 
	 * @return WURFL_Xml_ModelDevice
	 */
