...
function getPageFromMarkup($xhtml_lvl) {
	/*
	 * xhtml_support_level possible values: -1: No XHTML Support 0: Poor XHTML Support 1: Basic XHTML with Basic CSS Support 2: Same as Level 1 3: XHTML Support with Excellent CSS Support 4: Level 3 + AJAX Support
	 */
	if ($xhtml_lvl < 1) {
		return WML;
	}
