 ...
 *
 * @return array An array of plugin types, keyed by the type name.
 ...
 * particular type.
 * CTools invokes this same hook for all plugins, using the
 ...
 * @return string The path where CTools' plugin system should search for plugin files,
 ...
 *
 * @param $plugin An
 *        	associative array defining a plugin.
 * @param $info An
 *        	associative array of plugin type info.
 */
 ...
 *
 * @param $functions An
 *        	array which has the functions as value.
 */
 ...
 * @param $page If
 *        	TRUE then this renderer owns the page and can use theme('page')
