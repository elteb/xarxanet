	...
	?>
<div
	class="item-list views-rotator <?php print $views_rotator_id ?> clear-block">
	...
	<div class="view-rotator-next"></div>
	<div class="view-rotator-prev"></div>

	<div id="<?php print $views_rotator_id ?>">
    <?php foreach ($rows as $row): ?>
      <div
			class="views-rotator-item<?php if (views_rotator_display_item($views_rotator_id)) print '" style="display: none;"'; else print " vr-shown\""?>><?php print $row ?></div>
			<?php endforeach; ?></div>
	</div>