...
CKEDITOR.editorConfig = function(config) {
  ...
  config.toolbar_DrupalFiltered = [
    ...
    ['Undo','Redo','Find','Replace','-','SelectAll','RemoveFormat','Templates'],
  ...
  */
  config.toolbar_DrupalBasic = [ ['Source', '-', 'Format', '-', 'Bold', 'Italic', '-', 'NumberedList','BulletedList', '-', 'Link', 'Unlink', 'Image' ] ];
  ...
  config.toolbar_DrupalFull = [
      ['Source'],
      ['Cut','Copy','PasteText','PasteFromWord','-','SpellChecker', 'Scayt'], //,'Paste'
      ['Undo','Redo','Find','Replace','-','SelectAll','RemoveFormat','Templates'],
      ['Image','Flash','Table','HorizontalRule','Smiley','SpecialChar'],
      '/',
      ['Bold','Italic','Underline','Strike','-','Subscript','Superscript'],
