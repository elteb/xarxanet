 ...
 *
 * @return An associative array describing the data structure. Primary key is the
 ...
 *
 * @param $data An
 *        	array of all Views data, passed by reference. See hook_views_data() for
 *        	structure.
 *        	
 * @see hook_views_data()
 */
 ...
 *
 * @return An array on the form $plugins['PLUGIN TYPE']['PLUGIN NAME']. The plugin
 ...
 *
 * @return An array with the following possible keys:
 ...
 *
 * @return An associative array containing the structures of views, as generated from
 ...
 * @param $view The
 *        	View being executed.
 * @return An array with keys being the strings to replace, and the values the strings
 ...
 * 
 * @param $view The
 *        	view object about to be processed.
 * @param $display_id The
 *        	machine name of the active display.
 * @param $args An
 ...
 *        	view object about to be processed.
 * @param $output A
 *        	flat string with the rendered output of the view.
 * @param $cache The
 *        	cache settings.
 */
 ...
 *
 * @param $links An
 *        	array of links which will be displayed at the top of the view edit form.
 *        	Each entry should be on a form suitable for theme('link').
 * @param view $view
 *        	The full view object which is currently edited.
 * @param $display_id The
 *        	current display id which is edited. For example that's 'default' or
 *        	'page_1'.
 */
