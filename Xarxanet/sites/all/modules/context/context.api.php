 ...
 *        	node object.
 * @param $op The
 *        	node-related operation: 'node', 'form', 'comment'.
 */
...
/**
 * Alter a context directly after it has been loaded.
 * Allows modules to alter
 ...
 * 
 * @param $block_id ID
 *        	of block in module-delta format
 */
