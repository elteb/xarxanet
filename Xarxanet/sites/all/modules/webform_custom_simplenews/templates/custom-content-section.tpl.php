...
$links = array (
		'noticia_ambiental' => array (
				'ambiental',
				'Més notícies ambientals' 
		),
		'noticia_comunitari' => array (
				'comunitari',
				'Més notícies comunitàries' 
		),
		'noticia_cultural' => array (
				'cultural',
				'Més notícies culturals' 
		),
		'noticia_economic' => array (
				'economic/noticies',
				'Més notícies econòmiques' 
		),
		'noticia_formacio' => array (
				'formacio/noticies',
				'Més notícies sobre formació' 
		),
		'noticia_informatic' => array (
				'informatic/noticies',
				'Més notícies informàtiques' 
		),
		'noticia_internacional_ang' => array (
				'internacional/noticies/eng',
				'Més notícies internacionals - Anglès' 
		),
		'noticia_internacional_cat' => array (
				'internacional',
				'Més notícies internacionals' 
		),
		'noticia_internacional_esp' => array (
				'internacional/noticies/esp',
				'Més notícies internacionals - Castellà' 
		),
		'noticia_juridic' => array (
				'juridic/noticies',
				'Més notícies jurídiques' 
		),
		'noticia_projectes' => array (
				'projectes/noticies',
				'Més notícies sobre projectes' 
		),
		'noticia_social' => array (
				'social',
...
<table border="0" cellspacing="0" cellpadding="0"
	style='width: 580px; border-top: solid 20px #FFF; width: 580px;'>
	<tr>
		...
		<td style="width: <?php echo 580-(strlen($ambits[$section_name]))*2.7;?>px; text-align: right;"><a
			href='<?php echo $links[$section_name][0]; ?>'
			style='font-family: Georgia, Times New Roman, Times, serif; color: #005577; font-size: 11pt; text-decoration: none;'><?php echo $links[$section_name][1]; ?></a></td>
	</tr>
	<tr>
