	...
	$operations = array (
			'activate' => array (
					...
					'callback arguments' => array (
							SIMPLENEWS_SUBSCRIPTION_ACTIVE 
					) 
			),
			'inactivate' => array (
					'label' => t ( 'Inactivate' ),
					'callback' => 'simplenews_subscription_activate',
					'callback arguments' => array (
							SIMPLENEWS_SUBSCRIPTION_INACTIVE 
					) 
			),
			'delete' => array (
					'label' => t ( 'Delete' ),
 ...
 *
 * @param $node The
 *        	node that has just been spooled.
 */
 ...
 *        	subscriber object including all subscriptions of this user.
 *        	
 * @param $subscription The
 *        	subscription object for this specific subscribe action.
 *        	
 *        	@ingroup subscriber
 */
 ...
 *        	
 * @param $subscription The
 *        	subscription object for this specific unsubscribe action.
 *        	
 *        	@ingroup subscriber
 */
 ...
 *
 * @return An array keyed by the name of the class that provides the implementation,
