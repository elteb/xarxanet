...
<div id="sub-image-1">
	<div id="category">
		<div id="picto">
			<img src="/<?php print path_to_theme()?>/images/pictos/news-icons/notícia-internacional.gif" alt="noticia internacional" />
		</div>
		<div id="category-title">Notícia > Internacional</div>
	</div>
