...
<?php if ($rows): ?>
<div class="e_table">
	<table summary="Llistat finançaments">
		<thead>
		<tr>
		<th class="fin" scope="col"><?php print utf8_encode(t("Nom del finançament"))?></th>
		<th class="ter" scope="col"><?php print utf8_encode(t("Termini"))?></th>
	</tr>
		</thead>
	<tbody>
