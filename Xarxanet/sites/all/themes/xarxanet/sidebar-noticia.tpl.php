<div id="tools">
	...
	<div class="e_info">
      ...
      <dd><?php print $entitat_redactora; ?></dd>
			<dt><?php //print utf8_encode(t("Entitats"))?></dt>
			<?php //if($entitats[0]['value']!=""):?>
			<?php //foreach ($entitats as $entitat):?>
			<dd><?php //print $entitat['value']?></dd>
			<?php //endforeach;?>
			<?php //endif;?>
		 </dl>
    ...
    <?php endfor; ?>
     ...
     <?php endif; ?> <!-- Fi enllaços rel·lacionats -->
...
<?php if(sizeof($imatges)>0): ?>
      <div class="e_gallery">
		...
		<?php foreach ($imatges as $imatge):?>
		 <li>
            <a class="thickbox" href="<?php print base_path().$imatge['filepath']?>" rel="lightbox[noticia]" title="<?php print $imatge['data']['alt']?>">
