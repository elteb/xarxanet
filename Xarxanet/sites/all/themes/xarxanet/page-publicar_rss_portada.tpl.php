...
<head>
   <?php print $head ?>
   <?php $pagina = $_REQUEST['q']; ?>
    <?php if($pagina == 'recursos'): ?>
        <link rel="alternate" type="application/rss+xml" title="Feed RSS" href="http://www.xarxanet.org/rss_recursos" />
    <?php endif; ?>
...
<body class="l_ca t_00 h_01 p_00 recursos">
