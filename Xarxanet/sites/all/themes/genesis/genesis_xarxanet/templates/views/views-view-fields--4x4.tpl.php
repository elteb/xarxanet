...
<div class="<?php print xarxanet_get_class($tipus); ?>">
  ...
  $rawImatge = "";
    ...
    if($rawImatge == "") $rawImatge = $fields['field_agenda_imatge_fid_1']->content;
    if($rawImatge == "") $rawImatge = $fields['field_agenda_imatge_fid_2']->content;
  ...
  <div class="recuros-votacio">
        <div class="floatesquerra"><?php print $fields['value']->content; ?> </div>
        <div class="floatdreta "><?php print($fields['value_1']->label);?> <?php print $fields['value_1']->content; ?></div>
  </div>
  <?php endif;?>
  <?php if ($fields['field_date_event_value']->content):?>
  <div class="event-data">
    <div class="esvent-data">
      <div class="floatesquerra" ><strong>Inici</strong></div>
      ...
      <?php if ($fields['field_date_event_value']->raw!= $fields['field_date_event_value2']->raw):?>
		  ...
		  //date("d/m/Y \a \l\e\s H:i",  strtotime($fields['field_date_event_value']->raw)+7200);
		  ?></div>
          </div>
          <div class="esvent-data">
            <div class="floatesquerra" style="clear:left;"><strong>Termini</strong></div>
            <div class="floatdreta "><?php 
