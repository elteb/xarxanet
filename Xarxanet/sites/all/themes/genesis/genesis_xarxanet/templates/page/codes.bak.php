...
function modificacions_ie7(){
	...
	if (arg(0) == 'node') {
		...
		if (in_array($nid , $grup3))
			return '<script type="text/javascript" src="/sites/all/themes/genesis/genesis_xarxanet/css/ie7-fix-grup3.js"></script>';
		if (in_array($nid , $grup4))
			return '<script type="text/javascript" src="/sites/all/themes/genesis/genesis_xarxanet/css/ie7-fix-grup3.js"></script>';
		if (in_array($nid , $grup5))
			return '<script type="text/javascript" src="/sites/all/themes/genesis/genesis_xarxanet/css/ie7-fix-grup5.js"></script>';
		if (in_array($nid , $grup6))
			return '<script type="text/javascript" src="/sites/all/themes/genesis/genesis_xarxanet/css/financaments-fix.js"></script>';
	}
