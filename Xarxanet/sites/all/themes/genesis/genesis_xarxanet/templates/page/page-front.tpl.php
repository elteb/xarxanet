...
jQuery(document).ready(function() {
	...
	function nCols() {
		...
		var input = 'http://xarxanet.org'; // loc.href
...
<body id="genesis-1c" <?php print $section_class; ?>>
  <div id="container" class="<?php print $classes; ?> portada">
   ...
   <?php if ($site_logo or $site_name or $site_slogan): ?>
    ...
    <div id="columns-front" class="<?php print $body_classes; ?>"><div class="columns-inner clear-block">
    
      <div id="content-column"><div class="content-inner-front">
