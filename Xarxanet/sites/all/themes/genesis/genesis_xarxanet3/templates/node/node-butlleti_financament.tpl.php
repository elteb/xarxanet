...
<table class="butlleti" style="font-family: Arial, Helvetica; font-size: 13px; border:1px solid #53544F; border-bottom: 0px" width="910px" cellspacing="0px">
	...
	<tr><td>
		<a href="<?php echo $noticia_prin_esq['link']?>" style="text-decoration:none">
			<img src="<?php echo $pathroot.'/'.$noticia_prin_esq['imatge']?>" alt="<?php echo $noticia_prin_esq['alt']?>" style="border-right: 10px solid white;"/>
		</a>
	</td><td>
		<a href="<?php echo $noticia_prin_dreta['link']?>" style="text-decoration:none">
			<img src="<?php echo $pathroot.'/'.$noticia_prin_dreta['imatge']?>" alt="<?php echo $noticia_prin_dreta['alt']?>" style="border-left: 10px solid white;"/>
		</a>
	</td></tr>
	<tr><td>
			...
			<?php foreach ($node->field_financ_banner as $banner) {
				if (isset($banner['filepath'])) {?>
					<a style="text-decoration:none" href="<?php echo $banner['data']['url']?>">
						<img src="<?php echo $pathroot.'/'.$banner['filepath']?>" alt="<?php echo $banner['data']['alt']?>" width="265px" style="margin:2px 0;"/>
					</a>	
			<?php } 
			}?>
			<!-- BANNER FIXE -->
			<a style="text-decoration:none" href="http://www.twitter.com/ajuts_entitats">
				<img src="<?php echo $pathroot?>/sites/default/files/butlletins/financament/banner_twitter.jpg" alt="Banner Twitter" width="265px" style="margin:2px 0;"/>
			</a>
