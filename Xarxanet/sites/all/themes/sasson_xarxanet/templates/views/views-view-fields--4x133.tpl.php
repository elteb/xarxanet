...
<?php
	...
	if ($id == 1) {
		...
		if (strip_tags($rawImatge, '<img>') == '') $rawImatge = "<a href='" . $fields ['path']->content . "'>" . theme_image_style (array('style_name' => 'tag-gran', 'path' => 'public://no-image.jpg', 'title' => 'just a test image', 'alt' => 'test image')) . "</a>";
	} else if (($id == 2) || ($id == 7)) {
