...
?>
 <table class="butlleti"  style="font-family: Arial, Helvetica; font-size: 13px; border:1px solid #53544F; border-bottom: 0px; width:910px">
	...
	<?php if ($node->field_actualitat_recull_epigraf['und'][0]['value'] != '') { ?>
	 <table class="butlleti" style='width: 580px; margin-top: 20px'><tr>
		<td style="background-color: #B1290B; color: white; font-family: Georgia,Times New Roman,Times,serif; font-size: 12pt; padding: 0 8px; height: 28px; width: <?php echo (strlen(strip_tags($node->field_actualitat_recull_epigraf['und'][0]['value'])))*3;?>px"><?php echo $node->field_actualitat_recull_epigraf['und'][0]['value'];?></td>
