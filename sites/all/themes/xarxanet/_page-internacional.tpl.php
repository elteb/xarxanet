...
<head>
<?php print $head ?>
<link rel="alternate" type="application/rss+xml" title="Feed RSS" href="http://www.xarxanet.org/rss_internacional_cat" />
...
<body class="l_ca t_05 h_05 p_00">
...
<div id="page">
	<div id="header">
		...
		<div id="logo">
			<a href="<?php print base_path()?>"><img src="<?php echo  base_path() . path_to_theme();?>/img/hdr05_logo.jpg" alt="xarxanet.org - Xarxa associatius i de voluntariat de Catalunya" /></a>
		</div>
    ...
    <div class="copyright">
      ...
      <div class="gencat">
        <span class="label"><?php print t(utf8_encode("Amb el suport de"))?></span>
         <a href="http://www.gencat.cat/governacio-ap/ACCIO_CIUTADANA" rel="external"><img src="<?php echo  base_path() . path_to_theme();?>/img/ftr_sac.gif" alt="Generalitat de Catalunya. Departament de Governació i Administracions Públiques" /></a>
      </div>
    </div>
  </div> <!-- #footer -->
<?php print $closure?>
