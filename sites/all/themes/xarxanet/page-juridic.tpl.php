...
<head>
<?php print $head ?>
<link rel="alternate" type="application/rss+xml" title="Feed RSS" href="http://www.xarxanet.org/rss_juridic" />
...
<body class="l_ca t_09 h_09 p_00">
...
<div id="page">
	<div id="header">
		...
		<div id="logo">
			<a href="<?php print base_path()?>"><img src="<?php echo  base_path() . path_to_theme();?>/img/hdr09_logo.jpg" alt="xarxanet.org - Xarxa associatius i de voluntariat de Catalunya" /></a>
		</div>
