...
<head>
<?php print $head ?>
<?php $lang = substr($_REQUEST['q'],-3); ?>
<?php if($lang == 'esp'): ?>
        <link rel="alternate" type="application/rss+xml" title="Feed RSS" href="http://www.xarxanet.org/rss_internacional_esp" />
<?php elseif ($lang == 'eng'): ?>
        <link rel="alternate" type="application/rss+xml" title="Feed RSS" href="http://www.xarxanet.org/rss_internacional_ang" />
<?php else: ?>
