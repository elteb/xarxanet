...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (isAndroid) { bubbleInner.innerHTML = '<b>Instal·la aquesta web al teu dispositiu:</b> ' +
        'Afegeix-la als Preferits i a la Pantalla d\'Inici'; }
  else {
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'Instal·la aquesta web al teu dispositiu: ' +
        'prem a la fletxa i llavors <b>\'Afegeix a la Pantalla d\'Inici\'</b>';
  } else {
    bubbleInner.innerHTML = 'Instal·la aquesta web al teu dispositiu: ' +
        'prem <b style="font-size:15px">+</b> i llavors ' +
        '<b>\'Afegeix a la Pantalla d\'Inici\'</b>';
  }
  }
