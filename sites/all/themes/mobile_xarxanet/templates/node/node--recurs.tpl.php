...
<article id="<?php print $node_id; ?>" class="<?php print $classes; ?>">
	...
	<div class="node-body-text">
		...
		<ol class="sections">
	    <?php $i=0?>
	    <?php foreach($node->field_subtitols['und'] as $titol):?>
	    <?php if ($titol['value']!=''): ?>
	    ...
	    <!-- respostes -->
	    <?php $i=0;?>
	    <?php foreach($node->field_continguts['und'] as $contingut):?>
	    <?php if ($contingut['value']!=''): ?>
	    <h3 class="label-h3"><a name="<?php print ($i+1)?>"><?php print ($i+1).". ".$node->field_subtitols['und'][$i]['value']?></a></h3>
