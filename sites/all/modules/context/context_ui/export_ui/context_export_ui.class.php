...
class context_export_ui extends ctools_export_ui {
	...
	/**
	 * Override default final validation for ctools.
	 * With import wizard
 ...
 * @param $conditions The
 *        	full list of condition plugins
 * @param $reactions The
 *        	full list of reaction plugins
 *        	
 ...
 *        	context object to modify.
 * @param $form A
 *        	form array with submitted values
 * @param $submit A
 *        	flag indicating if we are building a context on submit. If on
...
/**
 * Replacement for ctools_export_ui_edit_name_validate().
 * Allow dashes.
 */
