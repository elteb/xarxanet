 ...
 *
 * @return An associative array containing information about the forms that can be
 ...
 *
 * @param $form_id The
 *        	form id to return information for.
 *        	
 * @return An associative array describing the form identified by $form_id:
