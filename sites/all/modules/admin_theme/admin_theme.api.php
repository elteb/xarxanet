 ...
 * settings page.
 *
 * @return A linear array of associative arrays. The keys of the linear array are
 ...
 * @param $option. The
 *        	option to check.
 * @return TRUE or FALSE indicating if the administration theme should be used.
 */
