 ...
 * the fivestar module.
 *
 * @return array An array of key => value pairs suitable for inclusion as the #options in a
 ...
 *        	within the type.
 * @param $tag The
 *        	VotingAPI tag string.
 * @param $uid The
 *        	user ID trying to cast the vote.
 *        	
 ...
 * @param $instance The
 *        	instance structures for the $field.
 *        	
 * @return array An array of key => value pairs. Each key must be unique the identifier for this
 ...
 *        	
 * @return array An array of key => value pairs. The return array must contain an entity_id key
