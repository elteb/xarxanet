...
<?php
  ...
  <tr>
		<td style="vertical-align: top;"><label
			for="<?php print $form['labels'][$key]['#id'] ?>"><?php print $labels[$key][0] ?> </label>
			<em><?php print $labels[$key][1]; ?></em></td>
		<td style="vertical-align: top;"
			<?php print $has_title_display ? '' : ' colspan="2"' ?>><?php print drupal_render($form['labels'][$key]); ?></td>
