 ...
 * @return array The pipe array of further processors that should be called.
 */
 ...
 *
 * @return array A keyed array of items, suitable for use with a FormAPI select or
 *         checkboxes element.
 */
 ...
 * @return array An associative array of rendered PHP code where the key is the name of the
 ...
 * @return boolean TRUE or FALSE for whether the components were successfully reverted.
 ...
 * the rendering of defaults.
 * Allows modules a final say in whether or not
 ...
 * This hook should be implemented
 ...
 * @{
 * Hooks to modify components defined by other features.
 ...
 * rebuilt, or reverted.
 * These are ONLY invoked on the Features module on
 * which these actions are taken.
 */

/**
 * Feature module hook.
 * Invoked on a Feature module before that module is
 * reverted.
 *
...
/**
 * Feature module hook.
 * Invoked on a Feature module after that module is
 * reverted.
 *
 * @param $component String
