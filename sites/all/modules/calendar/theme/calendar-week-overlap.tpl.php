...
<div class="calendar-calendar">
    ...
    <tr class="<?php print $rowclass?>">
      ...
      <td class="<?php print $agenda_hour_class ?>"
							rowspan="<?php print $multiday_rows?>"><span
							class="calendar-hour"><?php print t('All day', array(), array('context' => 'datetime'))?></span>
						</td>
      <?php endif; ?>
      <?php for($j = 0; $j < 7; $j++): ?>
        ...
        <?php if($cell != NULL && $cell['filled'] && $cell['wday'] == $j): ?>
          ...
          <?php
							...
							?>
          <td colspan="<?php print $cell['colspan']?>"
							class="<?php print $colclass?>">
							<div class="inner">
    ...
    <tr>
						<td class="<?php print $agenda_hour_class ?>"><span
							class="calendar-hour"><?php print t('All day', array(), array('context' => 'datetime'))?></span>
						</td>
      <?php for($j = 0; $j < 7; $j++): ?>
      <?php
    ...
    <table class="full">
          ...
          <?php if ($index == 0 ): ?>
          <td class="first"
							headers="<?php print $header_ids[$index]; ?>">
          <?php elseif ($index == 7 ) : ?>
          ...
          <?php endif; ?>
            <?php foreach ($start_times as $time_cnt => $start_time): ?>
              ...
              <div class="<?php print $class?>calendar-agenda-hour">
								<span class="calendar-hour"><?php print $time['hour']; ?></span><span
									class="calendar-ampm"><?php print $time['ampm']; ?></span>
							</div>
              <?php else: ?>
              <div
								class="<?php print $class?>calendar-agenda-items single-day">
                    ...
                    <?php if(!empty($items[$start_time]['values'][$index - 1])) :?>
                      <?php foreach($items[$start_time]['values'][$index - 1] as $item) :?>
                        ...
                        <div
											class="item <?php print $item['class']?> first_item">
                        <?php else : ?>
