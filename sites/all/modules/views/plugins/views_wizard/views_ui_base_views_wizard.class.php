...
class ViewsUiBaseViewsWizard implements ViewsWizardInterface {
	 ...
	 *
	 * @return An array whose keys are the names of each display and whose values are
	 ...
	 *
	 * @param $options An
	 *        	array whose keys are the name of each option and whose values are the
	 *        	desired values to set.
	 * @param $display The
	 *        	display which the options will be applied to. The default display
	 *        	will actually be assigned the options (and this display will inherit
	 *        	them) when possible.
	 * @param $default_display The
	 *        	default display, which will store the options when possible.
	 */
	 ...
	 *        	desired values.
	 * @param $display The
	 *        	display which the options will apply to. It will get the options by
	 *        	inheritance from the default display when possible.
	 * @param $default_display The
	 *        	default display, from which the options will be inherited when
	 *        	possible.
	 */
