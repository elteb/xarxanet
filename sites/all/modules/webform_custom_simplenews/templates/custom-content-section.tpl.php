...
<table border="0" cellspacing="0" cellpadding="0" style="width: 580px; border-top: solid 20px #FFF; width: 580px;">
	<tr>
		...
		<td style="width: <?php echo 580-(strlen($ambits[$section_name]))*2.7;?>px; text-align: right;"><a 	href='<?php echo $links[$section_name][0]; ?>' 	style='font-family: Georgia, Times New Roman, Times, serif; color: #005577; font-size: 11pt; text-decoration: none;'><?php echo $links[$section_name][1]; ?></a></td>
	</tr>
	<tr>
