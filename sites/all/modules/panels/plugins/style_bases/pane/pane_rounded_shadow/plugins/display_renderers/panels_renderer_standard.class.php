...
class panels_renderer_standard {
	/**
	 * The fully-loaded Panels display object that is to be rendered.
	 * "Fully
	...
	/**
	 * An associative array of loaded plugins.
	 * Used primarily as a central
	...
	/**
	 * A multilevel array of rendered data.
	 * The first level of the array
	...
	/**
	 * A multilevel array of data prepared for rendering.
	...
	/**
	 * Where to add standard meta information.
	 ...
	 * @return array An associative array of panes to be rendered, keyed on pane id and sorted
	 ...
	 * @return array An array of regions prepared for rendering.
	 */
	 ...
	 *
	 * @return string Themed & rendered HTML output.
	 */
	function render() {
	 ...
	 * will not be called.
	 *
	 * @return string The HTML string representing the entire rendered, themed panel.
	 */
	 ...
	 *
	 * @return array The array of rendered panes, keyed on pane pid.
	 */
	 ...
	 *
	 * @return array An array of rendered panel regions, keyed on the region name.
	 */
	 ...
	 *
	 * @param $region_id The
	 *        	ID of the panel region being rendered
	 * @param $panes An
	 *        	array of panes that are assigned to the panel that's being rendered.
	 *        	
	 * @return string The rendered, HTML string output of the passed-in panel region.
	 */
