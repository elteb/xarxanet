 ...
 *        	
 * @return array An associative array whose keys are jQuery selectors and whose values are
 ...
 *
 * @return array An associative array whose keys denote internal identifiers for a
