 ...
 *
 * @param $tree An
 *        	array containing the unrendered menu tree.
 * @param $config An
 *        	array containing the configuration of the tree.
 */
 ...
 *
 * @return An array containing the menus' machine names as keys with their menu titles
 *         as values.
 */
